...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/styles/ErrorPageStyle.css">
    ...
    <div class="container">
        ...
        <div class="instructions">
            ...
            <div class="step">
                ...
                <p><a href="javascript:history.go(-1)">Go previous page to try again</a></p>
            </div>
            <div class="step">
                ...
                <p><a href="${pageContext.request.contextPath}/init/main">Return to main page</a></p>
            </div>
        </div>
    </div>
    <!-- partial -->
